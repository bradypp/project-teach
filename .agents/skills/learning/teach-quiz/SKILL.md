...
Save under `quizzes/`, refresh the index and return an absolute file link. Quickly check content, answer keys and links; exhaustive browser testing is unnecessary.
