...
Evaluate the user's reasoning and follow `teach-update` for meaningful new evidence. Questions alone do not change learning state. Use `teach-quiz` for optional HTML practice; quiz completion is not an automatic update pipeline.
